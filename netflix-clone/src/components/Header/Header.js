...
const Header = (props) => {
    ...
    const signinHandler = () => {
        dispatch(pageActions.changePage({ page: 'signin'}))
    }
    const homeOpener = () => {
